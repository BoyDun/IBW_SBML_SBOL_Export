...
public class SBMLExportWizardPage extends WizardFileSystemResourceExportPage1 {
	 ...
	 * SBML export, the components include text fields to input a file name and a directory path.
	 * It also includes a button to browse for a directory and a checkbox to choose whether
	 * or not to flatten the EMF model.
	 */
    @Override
